...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Muhasebe.BankaHesaplar.BankaHesap", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Muhasebe.BankaSubeler.BankaSube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Bankalar.Banka", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Birimler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Cariler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Depolar.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Faturalar.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Faturalar.FaturaHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Hizmetler.Hizmet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Kasalar.Kasa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Makbuzlar.Makbuz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Makbuzlar.MakbuzHareket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Masraflar.Masraf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.OdemeBelgeleri.OdemeBelgesi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.OzelKodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Parametreler.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Stoklar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.Subeler.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Muhasebe.BankaHesaplar.BankaHesap", b =>
                {
                    b.HasOne("Muhasebe.BankaSubeler.BankaSube", "BankaSube")
                        .WithMany("BankaHesaplar")
                        .HasForeignKey("BankaSubeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Muhasebe.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1BankaHesaplar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2BankaHesaplar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.Subeler.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("Muhasebe.BankaSubeler.BankaSube", b =>
                {
                    b.HasOne("Muhasebe.Bankalar.Banka", "Banka")
            ...
            modelBuilder.Entity("Muhasebe.Faturalar.Fatura", b =>
                {
                    b.HasOne("Muhasebe.Cariler.Cari", "Cari")
                        .WithMany("Faturalar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.Donemler.Donem", "Donem")
                        .WithMany("Faturalar")
            ...
            modelBuilder.Entity("Muhasebe.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("Muhasebe.Depolar.Depo", "Depo")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.Faturalar.Fatura", "Fatura")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("FaturaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Muhasebe.Hizmetler.Hizmet", "Hizmet")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.Masraflar.Masraf", "Masraf")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.Stoklar.Stok", "Stok")
                        .WithMany("FaturaHareketler")
            ...
            modelBuilder.Entity("Muhasebe.Hizmetler.Hizmet", b =>
                {
                    b.HasOne("Muhasebe.Birimler.Birim", "Birim")
                        .WithMany("Hizmetler")
            ...
            modelBuilder.Entity("Muhasebe.Makbuzlar.Makbuz", b =>
                {
                    b.HasOne("Muhasebe.BankaHesaplar.BankaHesap", "BankaHesap")
                        .WithMany("Makbuzlar")
                    ...
                    b.HasOne("Muhasebe.Kasalar.Kasa", "Kasa")
                        .WithMany("Makbuzlar")
            ...
            modelBuilder.Entity("Muhasebe.Makbuzlar.MakbuzHareket", b =>
                {
                    ...
                    b.HasOne("Muhasebe.Bankalar.Banka", "CekBanka")
                        .WithMany("MakbuzHareketler")
                        .HasForeignKey("CekBankaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Muhasebe.BankaSubeler.BankaSube", "CekBankaSube")
                        .WithMany("MakbuzHareketler")
                    ...
                    b.HasOne("Muhasebe.Makbuzlar.Makbuz", "Makbuz")
                        .WithMany("MakbuzHareketler")
            ...
            modelBuilder.Entity("Muhasebe.Parametreler.FirmaParametre", b =>
                {
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("Muhasebe.Parametreler.FirmaParametre", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
